...
const SECTIONS: Record<string, [string, string]> = {
  organize: ["Organize", "The shape of the map and what sits where on it: jobs and sub-jobs, and the curation that ranks each resource."],
  queues: ["Review queues", "Everything waiting on a decision: shared materials, items flagged as dated, drafts reviewed, and questions offered for review."],
