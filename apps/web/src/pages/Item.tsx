  ...
  return (
    <div className="wf-page">
      ...
      <div className="wf-page-header">
        ...
        <div className="wf-record-actions"><a href={item.url} target="_blank" rel="noreferrer" onClick={() => signalClick(item.id, { from: "item", external: true })}><ExternalLink size={16} /> Open in Connected</a></div>
      </div>
      <div className="two-col">
        <div>
          <article className="wf-card wf-card-section">
            ...
            {!item.bodyHtml && !item.attachments.length && !item.linkedDocs.length && !item.contents.length ? <p className="muted">This item has no readable content in Connected beyond its title.</p> : null}
          </article>
