...
export function MaterialType() {
  ...
  return (
    <div className="wf-page">
      <Link to="/materials" className="wf-page-back">← Get feedback</Link>
